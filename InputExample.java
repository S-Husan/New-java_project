...
public class InputExample {
    public static void main(String[] args) {
        ...
        // String s = new String(""); Here, s referce to an object in which there are no characters.
    
        // String t = null; //Means there is nothing here.

        // if(str.length() == 0) of if(str.equals(""))


        // we can check the null string use the followig code
        // if(str == null)

        // example
        // String s = null;
        // if (s== null){
        //     System.out.println("String is null,Operator is aborted");
        // }
        // if (s.length() == 0){
        // }    
        //...........................................................//
